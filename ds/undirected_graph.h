...
namespace ds {
namespace {
using dyn_delta_approx::utils::FullRange;
using dyn_delta_approx::utils::Range;
...
class UndirectedGraph {
 ...
 public:
  ...
  void removeEdge(NodeType u, NodeType v) { throw; }
  void shrink_to_size() {}
  auto edges() const {
  ...
  auto initialNumNodes() const { return _adj_array.size(); }
  auto initialNumEdges() const { return _edges.size(); }
